...
const GameResult = () => {
    ...
    const [DefRank, setDefRank] = useState();
    console.log(data)
    ...
    useEffect(() => {
        ...
        const addGoldText = (text, x, y, width, height, cornerRadius, fontSize, fontWeight,
            ...
            if (isGoldText) {
                const goldText = new PIXI.Text( "  ➔   " + updatedAtkGold + " 하락 ",
                    {
                        fontSize: 22,
                        fill: 0x0f1828,
                        align: 'justify',
        ...
        const addPointText = (text, x, y, width, height, cornerRadius, fontSize, fontWeight,
            ...
            if (isPointText) {
                const pointText = new PIXI.Text( "  ➔   " + updatedAtkPoint + " 하락 ",
                    {
                        fontSize: 22,
                        fill: 0x0f1828,
                        align: 'justify',
