...
const DefenderSkill = ({ setFlag }) => {
    ...
    useEffect(() => {
        ...
        const addRoundedText = (text, x, y, width, height, cornerRadius, fontSize, fontWeight) => {
            ...
            const handleClick0 = async () => {
                ...
                try {
                    ...
                    if (text === '저장하기') {
                        if (!defenderAttackTypeSkill || !defenderDefensiveTypeSkill || !defenderUtilityTypeSkill) {
                            alert('스킬을 모두 선택해주세요.');
                            return;
                        }
        ...
        addDefenseSkillBox(Heal, '회복 [35%]', '잃은 체력의 30%에            해당하는 양을 회복', '#FFFFFF');
        addDefenseSkillBox(
            IronCladDefense,
            '철통방어 [35%]',
